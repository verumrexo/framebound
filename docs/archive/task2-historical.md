# historical framebound development notes

archived on 2026-07-27. this file is not an approved implementation roadmap.
completed technical work is tracked in `../../ROADMAP.md`; unchecked items below
remain unapproved creative ideas unless the user explicitly revives them.
