...
export class Designer {
    ...
    buildUI() {
        ...
        this.ui.innerHTML = `
            <style>
                .part-designer-v2{position:fixed;inset:2.5vh 2.5vw;z-index:1400;display:none;background:#090d16;color:#e9f1ff;border:1px solid #345276;box-shadow:0 18px 70px #000c;font:11px 'Press Start 2P',monospace;overflow:hidden}
                .pd-head,.pd-foot{display:flex;align-items:center;gap:10px;padding:12px 14px;background:#0d1422;border-bottom:1px solid #243a57}.pd-head h2{font-size:15px;margin:0;color:#72b7ff}.pd-head .pd-spacer,.pd-foot .pd-spacer{flex:1}.pd-main{height:calc(100% - 118px);display:grid;grid-template-columns:210px minmax(300px,1fr) 430px;min-height:0}.pd-side{padding:12px;border-right:1px solid #243a57;overflow:auto}.pd-preview-side{border-right:0;border-left:1px solid #243a57}.pd-section{margin-bottom:16px}.pd-label{display:block;color:#7891ad;font-size:8px;margin:0 0 7px}.pd-row{display:flex;gap:6px;align-items:center;flex-wrap:wrap}.pd-btn,.pd-select,.pd-input{background:#101b2d;color:#e9f1ff;border:1px solid #355579;padding:8px;font:9px inherit}.pd-btn{cursor:pointer}.pd-btn.is-on{color:#08111d;background:#68b7ff;border-color:#b7dcff}.pd-btn.is-warn{border-color:#b66b6b}.pd-canvas-wrap{display:flex;align-items:center;justify-content:center;min-width:0;min-height:0;padding:16px;background:#050810;overflow:auto}.pd-canvas{image-rendering:pixelated;background:#090d14;border:1px solid #45698e;cursor:crosshair;box-shadow:0 0 0 1px #000}.pd-palette{display:grid;grid-template-columns:repeat(4,1fr);gap:5px}.pd-swatch{height:30px;padding:0;border:2px solid transparent;background:#111;cursor:pointer}.pd-swatch.is-on{border-color:#fff}.pd-swatch input{width:100%;height:100%;border:0;padding:0;background:none}.pd-preview{width:100%;height:auto;image-rendering:pixelated;background:#050810;border:1px solid #355579}.pd-help{font:9px/1.65 system-ui,sans-serif;color:#9fb1c7}.pd-status{font:9px system-ui,sans-serif;color:#78e6a2}.pd-text{width:100%;min-height:54px;box-sizing:border-box;resize:vertical}.pd-advanced{margin-top:8px}.pd-advanced textarea{width:100%;height:90px;box-sizing:border-box}.pd-marker-list{font:9px/1.7 system-ui,sans-serif;color:#a9bdd4}.pd-projectile-preview{width:100%;height:56px;image-rendering:pixelated;background:#050810;border:1px solid #355579}
                @media(max-width:1050px){.pd-main{grid-template-columns:190px 1fr}.pd-preview-side{grid-column:1/3;border-left:0;border-top:1px solid #243a57}.part-designer-v2{overflow:auto}.pd-main{height:auto}.pd-canvas-wrap{min-height:450px}}
            </style>
