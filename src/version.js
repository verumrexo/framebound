...
export const CHANGELOG = [
    {
        ...
        items: [
            ...
            'rendering: normal gameplay offers 1x and 2x hard-raster webgl2 modes, with 2x recommended for smooth motion and complete 16px ship lines; developer visual proofs retain 1x/2x/3x comparison controls.',
